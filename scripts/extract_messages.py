...
KNOWN_EN = {
    ...
    'Déconnexion': 'Logout',
    'Consultation': 'View',
    # UserActivity descriptions
    'Création du compte %(username)s pour %(name)s': 'Account created for %(name)s (%(username)s)',
    'Réinitialisation du mot de passe via email': 'Password reset via email',
    'Changement de mot de passe': 'Password changed',
    'Mise à jour du profil': 'Profile updated',
    "Modification de l'utilisateur %(username)s": 'User %(username)s modified',
    "Suppression de l'utilisateur %(username)s": 'User %(username)s deleted',
    'Activation du compte via lien email': 'Account activated via email link',
    # ProjectActivity descriptions
    "Ajout automatique du responsable '%(name)s' à l'équipe": "Manager '%(name)s' automatically added to the team",
    "Ajout du besoin '%(title)s'": "Need '%(title)s' added",
    "Ajout d'un commentaire": 'Comment added',
    "Import JSON : création du projet '%(name)s'": "JSON import: project '%(name)s' created",
    "Création du projet '%(name)s'": "Project '%(name)s' created",
    'Modification des informations du projet': 'Project information modified',
    "Ajout du jalon '%(name)s'": "Milestone '%(name)s' added",
    "Modification du jalon '%(name)s'": "Milestone '%(name)s' modified",
    "Suppression du jalon '%(milestone_name)s'": "Milestone '%(milestone_name)s' deleted",
    "Ajout de la sous-étape '%(sub_name)s' au jalon '%(milestone_name)s'": "Sub-step '%(sub_name)s' added to milestone '%(milestone_name)s'",
    "Modification de la sous-étape '%(name)s'": "Sub-step '%(name)s' modified",
    "Suppression de la sous-étape '%(sub_name)s'": "Sub-step '%(sub_name)s' deleted",
    "Réassignation du jalon '%(name)s'": "Milestone '%(name)s' reassigned",
    "Réassignation de la sous-étape '%(name)s'": "Sub-step '%(name)s' reassigned",
    "Sous-étape '%(name)s' marquée comme %(status)s": "Sub-step '%(name)s' marked as %(status)s",
    "Jalon '%(name)s' marqué comme %(label)s": "Milestone '%(name)s' marked as %(label)s",
    "Statut de '%(name)s' : %(status_old)s → %(status_new)s": "Status of '%(name)s': %(status_old)s → %(status_new)s",
    "Statut du besoin '%(title)s' → %(status)s": "Need '%(title)s' status → %(status)s",
    "Ajout de la tâche '%(name)s'": "Task '%(name)s' added",
    "Mise à jour de la tâche '%(name)s'": "Task '%(name)s' updated",
    "Création du dossier '%(name)s'": "Folder '%(name)s' created",
    "Modification du dossier '%(name)s'": "Folder '%(name)s' modified",
    "Suppression du dossier '%(folder_name)s'": "Folder '%(folder_name)s' deleted",
    "Ajout du document '%(title)s'": "Document '%(title)s' added",
    "Modification du document '%(title)s'": "Document '%(title)s' modified",
    "Suppression du document '%(doc_title)s'": "Document '%(doc_title)s' deleted",
    "Ajout du membre '%(name)s' (%(role)s)": "Member '%(name)s' added (%(role)s)",
    "Rôle de '%(name)s' modifié → '%(role)s'": "Role of '%(name)s' changed → '%(role)s'",
    "Retrait du membre '%(member_name)s'": "Member '%(member_name)s' removed",
    "Statut changé vers '%(status_label)s'": "Status changed to '%(status_label)s'",
    'Erreur de lecture : %(error)s': 'Error reading: %(error)s',
    'JSON invalide : %(error)s': 'Invalid JSON: %(error)s',
    # Permission choices
    'Lire': 'Read',
    'Créer': 'Create',
    'Modifier': 'Edit',
